...
public partial class New_Submission_Requering_Assignments : System.Web.UI.Page
{
    String quer;
    int My_No;
    decimal Total;
  ...
  SqlCommand commands = new SqlCommand();
    ...
    /*  void load2() {
          ...
          GridView2.DataSource = Read_Question;
          GridView2.DataBind();
          Read_Question.Close();
      }*/
    void load()
    {
        ...
        quer = " select Articles.Article_No ,Article_Types.Article_Type_Name,   " +
    ...
    /*  protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
      {
          String Information_about_Journal = "";
          FunctionSumation obUnassign = new FunctionSumation();
          int My_No = Convert.ToInt16(Session["User_No"]);
          if (e.Row.RowType == DataControlRowType.Footer)
          {      
               Information_about_Journal = obUnassign.information_fro_Save(My_No);
              e.Row.Cells[3].Text = Information_about_Journal;
          }
      }*/
