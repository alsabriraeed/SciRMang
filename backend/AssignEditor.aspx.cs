...
public partial class AssignEditor : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                commands.CommandText = "select DISTINCT Users.User_No,Users.User_Name,Role_Table.Role_Name from Users, " +
                  "(select DISTINCT User_Role.User_No,Role.Role_Name from User_Role,Role " +
                   ...
                   " AND  Users.User_No NOT IN (select Lower_User_No from Article_User where Article_User.Article_No=@Article_No)" +

                   " AND Users.User_No NOT IN " +
                        "( select Article_Status_Users.User_No  from Article_Status_Users where Article_Status_Users.Status_No " +
                       ...
                       " AND Status.Status_Name LIKE 'Recieved'  )AND Article_Status_Users.Article_No=@Article_No)" +
                ...
                "    Secondary_Permission.Permission_Name LIKE 'Recive Assignment Without Invitation') ) ";
                commands.Parameters.Add("@Article_No", System.Data.SqlDbType.Int);
                commands.Parameters["@Article_No"].Value = article_No;
                Read_Question = commands.ExecuteReader();
    ...
    protected void Datasource_Editor_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    /*   protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
       {
           ...
           if (e.CommandName == "Editor_Names")
           {
               ViewState["Editor_Names"] = e.CommandArgument ;
               selectedValue = Convert.ToString(ViewState["Editor_Names"]);
    ...
    protected void CmdCancel0_Click1(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/AssignEditor_ConfirmSelectionandCustomizeLetters.aspx");
