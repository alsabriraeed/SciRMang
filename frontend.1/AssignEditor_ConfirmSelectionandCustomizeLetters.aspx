<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AssignEditor_ConfirmSelectionandCustomizeLetters.aspx.cs" Inherits="AssignEditor_ConfirmSelectionandCustomizeLetters" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 686px; font-family: 'MS Reference Sans Serif'; font-weight: normal; font-size: x-small; width: 953px;">
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" 
            Text="Assign Editor- Confirm Selection and Customize Letters"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <br />
