<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="beginUnassignEditor.aspx.cs" Inherits="beginUnassignEditor" Title="Untitled Page" %>
                ...
                <table cellpadding="0" cellspacing="0" class="style3">
                    <tr>
                        <td align="center" class="" 
                            ...
                            valign="middle">
                            <br />
                            Please Select Editor that want Unassign<br />
&nbsp;<table cellpadding="0" cellspacing="0" class="" width="800px">
                                <tr>
                            ...
                            <br />
                            <table cellpadding="0" cellspacing="0" class="" style="width: 796px">
                                <tr>
                                    <td align="center" class="" 
                                        style="font-family: 'MS Reference Sans Serif'; font-size: small; background-color: #00008F; color: #FFFFFF; font-weight: bold;">
                                        Classifications&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <!--         <asp:Repeater runat="server"  ID="Datasourse_Editor">      <HeaderTemplate>   <table class="style6">
                   ...
                   <!-- DataSourceID="Datasourse_Editor" -->
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                style="margin-right: 300px; margin-left: 0px;" Width="800px">
