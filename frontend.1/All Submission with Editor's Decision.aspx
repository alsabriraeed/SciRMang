<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="All Submission with Editor's Decision.aspx.cs" Inherits="All_Submission_with_Editor_s_Decision" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                All Submission with Editor&#39;s Decision For
            ...
            &nbsp;<asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="#000066" 
                Text="All submissions for which an Editor has submited a decision "></asp:Label>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:GridView ID="db_AllsubmissionDecision" runat="server" AllowPaging="True" 
                ...
                onpageindexchanged="db_AllsubmissionDecision_PageIndexChanged" 
                onpageindexchanging="db_AllsubmissionDecision_PageIndexChanging" 
                onrowcommand="db_AllsubmissionDecision_RowCommand" 
                onrowdatabound="db_AllsubmissionDecision_RowDataBound" 
                onselectedindexchanged="db_AllsubmissionDecision_SelectedIndexChanged" 
                onsorting="db_AllsubmissionDecision_Sorting" PageSize="1" Width="1466px">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <br />
                            <asp:LinkButton ID="View_Reviews_and_comments" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' 
                                CommandName="View_Reviews_and_comments" PostBackUrl="" 
                                Text="View Reviews and comments" />
                            <br />
                            <asp:LinkButton ID="Notify_Author" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Notify_Author" 
                                PostBackUrl="" Text="Notify Author" />
                            <br />
                            <asp:LinkButton ID="Set_Final_Desicion" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Set_Final_Desicion" 
                                PostBackUrl="" Text="Set Final Desicion" />
                            <br />
                        </ItemTemplate>
