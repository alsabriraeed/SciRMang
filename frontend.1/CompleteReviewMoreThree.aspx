<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CompleteReviewMoreThree.aspx.cs" Inherits="CompleteReviewMoreThree" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            ...
            <br />
            <br />
            <asp:GridView ID="db_CompleteReviewerM3" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_CompleteReviewerM3_PageIndexChanged" 
                onpageindexchanging="db_CompleteReviewerM3_PageIndexChanging" 
                onrowcommand="db_CompleteReviewerM3_RowCommand" 
                onselectedindexchanged="db_CompleteReviewerM3_SelectedIndexChanged" 
                onsorting="db_CompleteReviewerM3_Sorting" PageSize="1" Width="1466px">
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="History" runat="server" 
                                ...
                                Text="History" />
                            <br />
                            <asp:LinkButton ID="View_Reviewe_Comments" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="View_Reviewe_Comments" 
                                PostBackUrl="" Text="View Reviewe Comments" />
                            <br />
                            ...
                            <br />
                            <asp:LinkButton ID="Reviewers_Invite" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Reviewers_Invite" 
                                PostBackUrl="" Text="Reviewers Invite" />
                            <br />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Reviewer Name ">
                        <ItemTemplate>
                            <asp:LinkButton ID="count_Editors" runat="server" 
                                ...
                                PostBackUrl="" Text=' <%#Eval("User_Name")%>' />
                            <br />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
