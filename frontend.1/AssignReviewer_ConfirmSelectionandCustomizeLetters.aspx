<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AssignReviewer_ConfirmSelectionandCustomizeLetters.aspx.cs" Inherits="AssignReviewer_ConfirmSelectionandCustomizeLetters" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 686px; font-family: 'MS Reference Sans Serif'; font-weight: normal; font-size: x-small; width: 953px;">
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" 
            Text="Assign Reviewer- Confirm Selection and Customize Letters"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        ...
        <fieldset style="border: 1px solid #000000; height: 98px; background-color: #F2F2F2; width: 904px;">
            ...
            <table cellpadding="0" cellspacing="0" class="style25" 
                ...
                <tr>
                    <td align="left" class="style26" style="border-style: solid; border-width: 1px">
                        <asp:LinkButton ID="Reviewer_Name" runat="server">LinkButton</asp:LinkButton>
                    </td>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="CmdClose0" runat="server" onclick="CmdClose0_Click" 
