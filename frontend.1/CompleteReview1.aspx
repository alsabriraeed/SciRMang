<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CompleteReview1.aspx.cs" Inherits="CompleteReview1" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            ...
            result per page.<br />
            &nbsp;&nbsp;&nbsp;
            <asp:GridView ID="db_CompleteReviewer" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_CompleteReviewer_PageIndexChanged" 
                onpageindexchanging="db_CompleteReviewer_PageIndexChanging" 
                onrowcommand="db_CompleteReviewer_RowCommand" 
                onselectedindexchanged="db_CompleteReviewer_SelectedIndexChanged" 
                onsorting="db_CompleteReviewer_Sorting" PageSize="1" Width="1466px">
