<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AcceptSubmission.aspx.cs" Inherits="AcceptSubmission" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                View All&nbsp; Submissions With Accept&nbsp; For
            ...
            <asp:Label ID="Current_Page" runat="server" Text="1"></asp:Label>
            &nbsp;Of&nbsp;
            ...
            &nbsp;&nbsp;&nbsp;
            <br />
            <asp:GridView ID="db_Accept" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="1" 
                EditIndex="0" onpageindexchanged="db_Accept_PageIndexChanged1" 
                onpageindexchanging="db_Accept_PageIndexChanging" 
                onrowcommand="db_Accept_RowCommand" onrowdatabound="db_Accept_RowDataBound" 
                onselectedindexchanged="db_Accept_SelectedIndexChanged" 
                onsorting="db_Accept_Sorting" PageSize="1" Width="1466px">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <br />
                            <asp:LinkButton ID="Linked_Submission_Group" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' 
                                CommandName="Linked_Submission_Group" PostBackUrl="" 
                                Text="Linked Submission Group" />
                            <br />
                        </ItemTemplate>
