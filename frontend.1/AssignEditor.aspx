<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AssignEditor.aspx.cs" Inherits="AssignEditor" Title="Untitled Page" %>
                    ...
                    <tr>
                        <td align="center" class="style4" 
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" class="style3">
                                <tr>
                                    <td align="center" class="style11" width=" " 
                                        style="font-family: 'MS Reference Sans Serif'; font-size: small; background-color: #00008F; color: #FFFFFF; font-weight: bold; text-align: justify;">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ManuscriptClassifications</td>
                                </tr>
                                <tr>
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" class="style3">
                                <tr>
                                    ...
                                    <td align="center" class="" 
                                        ...
                                        <br />
                                        Matches</td>
                                    <td align="center" class="style13" colspan="2" width=" " 
                                        style="font-family: 'MS Reference Sans Serif'; font-size: small; background-color: #00008F; color: #FFFFFF; font-weight: bold;">
                                        Current Arguments</td>
                                    <td align="center" class="style13" width=" " 
                                        style="font-family: 'MS Reference Sans Serif'; font-size: small; background-color: #00008F; color: #FFFFFF; font-weight: bold;">
                                        Editor&nbsp; Name</td>
                                </tr>
                                <tr>
                                    <td align="left" bgcolor="White" class="style9" 
                                    ...
                                    <td align="left" bgcolor="White" class="style10" colspan="2" 
                                        style="font-family: 'MS Reference Sans Serif'; font-size: small; background-color: #FFFFFF; color: #000000; font-weight: normal;" 
                                        width=" ">
                                        &nbsp;&nbsp;
              ...
              <!--         <asp:Repeater runat="server"  ID="Datasourse_Editor">      <HeaderTemplate>   <table class="style6">
                   ...
                   <!-- DataSourceID="Datasourse_Editor" -->
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                style="margin-right: 122px; margin-left: 23px;" Width="703px">
                    ...
                    <tr>
                        <td align="center" bgcolor="#00008F" class="style4" 
                            ...
                            valign="top">
                <asp:Button ID="CmdCancel" runat="server" BackColor="#F2F2F2" Height="27px" 
                    onclick="CmdCancel_Click" Text="Cancel" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="CmdCancel0" runat="server" BackColor="#F2F2F2" Height="24px" 
