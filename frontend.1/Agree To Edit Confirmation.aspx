<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Agree To Edit Confirmation.aspx.cs" Inherits="Agree_To_Edit_Confirmation" Title="Untitled Page" %>
        ...
        <table align="center" bgcolor="White" border="4" cellpadding="4" 
            ...
            <tr>
                <td class="style3" dir="ltr" 
                    ...
                    <br />
                    <br class="style5" />
                    <span class="style6">AGREE TO EDIT CONFIRMATION</span>
                </td>
                <td class="style2" style="border-style: none" valign="top">
                    ...
                    &nbsp;<fieldset id="field1" runat="server" 
                        ...
                        <asp:Label ID="Label2" runat="server" style="margin-left: 31px" 
                            Text="thank you for agreeing  to Edit manuescripet number " Width="49%"></asp:Label>
                        <asp:Label ID="Current_date" runat="server"></asp:Label>
                        &nbsp;<asp:Label ID="Label4" runat="server" Text="."></asp:Label>
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label5" runat="server" 
                            Text="to Edit manuscript please click the 'New Assignment' link blow" 
                            Width="80%"></asp:Label>
                        <br />
                        <br />
                        <hr noshade="noshade" style="height: 2px; width: 90%; color: #FF0000" />
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" 
                            NavigateUrl="~/New Assignments.aspx" 
                            style="text-decoration: underline; color: #0000CC">New Assignment</asp:HyperLink>
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
