<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Direct  to Editor Revised Submissions .aspx.cs" Inherits="Direct__to_Editor_Revised_Submissions_" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                Direct To Editor Revised Submissions -&nbsp;for
            ...
            &nbsp;<asp:Label ID="Label7" runat="server" Font-Bold="True" ForeColor="#000066" 
                Text="Direct To Editor Revised submissions Recieved."></asp:Label>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            &nbsp;&nbsp;&nbsp;
            <br />
            <asp:GridView ID="db_revised" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CaptionAlign="Left" 
                CellPadding="3" DataKeyNames="Article_No" GridLines="Horizontal" 
                onpageindexchanged="db_revised_PageIndexChanged" 
                onpageindexchanging="db_revised_PageIndexChanging" 
                onrowcommand="GridView1_RowCommand" onrowdatabound="db_revised_RowDataBound" 
                onselectedindexchanged="GridView1_SelectedIndexChanged" 
                onsorting="db_revised_Sorting" PageSize="1" Width="1197px">
