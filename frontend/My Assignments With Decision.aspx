<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="My Assignments With Decision.aspx.cs" Inherits="My_Assignments_With_Decision" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            ...
            <br />
            <br />
            <asp:GridView ID="db_MyAssignmentDecision" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_MyAssignmentDecision_PageIndexChanged" 
                onpageindexchanging="db_MyAssignmentDecision_PageIndexChanging" 
                onrowcommand="db_MyAssignmentDecision_RowCommand" 
                onselectedindexchanged="db_MyAssignmentDecision_SelectedIndexChanged" 
                onsorting="db_MyAssignmentDecision_Sorting" PageSize="1" Width="1466px">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <br />
                            <asp:LinkButton ID="View_Editor_Comments" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="View_Editor_Comments" 
                                PostBackUrl="" Text="View Editor Comments" />
                            <br />
                    ...
                    <asp:TemplateField HeaderText="Date Complete Submissin">
                        <ItemTemplate>
                            <%#Eval("complete_date")%>
                        </ItemTemplate>
                    </asp:TemplateField>
