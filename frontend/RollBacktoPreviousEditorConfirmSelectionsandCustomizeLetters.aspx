<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RollBacktoPreviousEditorConfirmSelectionsandCustomizeLetters.aspx.cs" Inherits="RollBacktoPreviousEditorConfirmSelectionsandCustomizeLetters" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 686px; font-family: 'MS Reference Sans Serif'; font-weight: normal; font-size: x-small; width: 953px;">
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" 
            Text="Roll Back to Previous Editor- Confirm Selection and Customize Letters"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<fieldset class="style25" 
            style="width: 753px; height: 138px">
            <br />
            The following people are configured to receive a letter when an Editor is 
            assigned to a submission.&nbsp;and the submission is reassigned (rolled back)&nbsp;&nbsp; to 
            the&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; previous Editor.&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            Click&nbsp;
            ...
            to that person&#39;s name and select a different letter. Note: if you personalize a 
            letter, and then select a new letter, your personalized text will be lost.<br />
            <br />
            If there is a person in the list to whom you do not want to send a letter, check 
            the Do Not Send Letter box next to that person&#39;s name. When you click
            <asp:Label ID="Label2" runat="server" Font-Bold="True" 
                Text="Confirm Selections and Send Letters,"></asp:Label>
            &nbsp;that person will not be sent a letter.&nbsp;&nbsp;<br />
        </fieldset><br />
        <br />
        <br />
        <br />
