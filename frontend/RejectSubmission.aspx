<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RejectSubmission.aspx.cs" Inherits="RejectSubmission" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                View All&nbsp; Submissions With Reject&nbsp; for
            ...
            &nbsp;&nbsp;&nbsp;
            <br />
            <asp:GridView ID="db_Reject" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_Reject_PageIndexChanged" 
                onpageindexchanging="db_Reject_PageIndexChanging" 
                onrowcommand="db_Reject_RowCommand" onrowdatabound="db_Reject_RowDataBound" 
                onselectedindexchanged="db_Reject_SelectedIndexChanged" 
                onsorting="db_Reject_Sorting" PageSize="1" Width="1466px">
