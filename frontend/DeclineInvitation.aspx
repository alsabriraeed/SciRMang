<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DeclineInvitation.aspx.cs" Inherits="DeclineInvitation" Title="Untitled Page" %>
            ...
            <tr>
                ...
                <td id="T" class="style2" style="border-style: none" valign="top">
                    ...
                    &nbsp;<fieldset id="field1" runat="server" 
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="Reason_Decline" runat="server" Height="173px" Width="607px" 
