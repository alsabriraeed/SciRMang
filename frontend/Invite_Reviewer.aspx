<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Invite_Reviewer.aspx.cs" Inherits="Invite_Reviewer" Title="Untitled Page" %>
                    ...
                    <tr>
                        <td align="center" class="style4" 
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" class="" 
                                style="width: 688px; margin-left: 17px">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" bgcolor="White" class="" colspan="2" 
                                        ...
                                        width=" ">
                                        &nbsp;&nbsp;
                                        <asp:Label ID="Reviwer_Name" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
              ...
              <!--         <asp:Repeater runat="server"  ID="Datasourse_Editor">      <HeaderTemplate>   <table class="style6">
                   ...
                   <!-- DataSourceID="Datasourse_Editor" -->
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                style="margin-right: 122px; margin-left: 16px;" Width="673px">
                                <FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" />
                                <RowStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" />
                                <Columns>
                                    <asp:CommandField ButtonType="Button" HeaderText="Select" 
                                        ShowSelectButton="True" />
                                    <asp:TemplateField HeaderText="Reviewer Role">  <ItemTemplate><%#Eval("Role_Name")%> </ItemTemplate></asp:TemplateField>
