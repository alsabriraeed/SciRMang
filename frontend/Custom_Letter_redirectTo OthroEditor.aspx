<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Custom_Letter_redirectTo OthroEditor.aspx.cs" Inherits="Custom_Letter_redirectTo_OthroEditor" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div align="center" 
        ...
        <br />
        <fieldset style="height: 445px; width: 812px; background-color: #F2F2F2;">
            <br />
            <table align="center" cellpadding="0" cellspacing="0" class="" 
                ...
                <tr valign="top">
                    <td class="" colspan="2" valign="bottom">
                        <br />
                        &nbsp;&nbsp;<asp:TextBox ID="Txt_message_content" runat="server" Height="264px" 
