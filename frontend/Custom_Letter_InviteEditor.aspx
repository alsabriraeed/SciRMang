<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Custom_Letter_InviteEditor.aspx.cs" Inherits="Custom_Letter_InviteEditor" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div align="center" 
        ...
        style="border-width: 1px; border-style: solid; height: 663px; font-family: 'MS Reference Sans Serif'; font-weight: bold; font-size: small; width: 826px;">
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Customize Letter - Ad-hoc from editor<br />
        <br />
        <fieldset style="width: 816px; height: ; background-color: #F2F2F2; font-weight: normal; font-size: x-small;">
            <br />
        ...
        <fieldset style="height: ; width: 812px; background-color: #F2F2F2;">
            ...
            <table align="center" cellpadding="0" cellspacing="0" class="" 
                ...
                <tr valign="top">
                    <td align="left" class="" style="border: 1pt solid #FFFFFF;">
                        Letter Body:</td>
                    <td class="style9" style="border: 1pt solid #FFFFFF;" valign="middle">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr valign="top">
                    <td class="" colspan="2" valign="bottom">
                        <br />
                        &nbsp;&nbsp;<asp:TextBox ID="Txt_message_content" runat="server" Height="278px" 
