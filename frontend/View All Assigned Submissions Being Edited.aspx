<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="View All Assigned Submissions Being Edited.aspx.cs" Inherits="View_All_Assigned_Submissions_Being_Edited" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                View All Assigned Submissions For
            ...
            &nbsp;&nbsp;&nbsp;
            <br />
            <asp:GridView ID="db_VeiwAllAssign" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_VeiwAllAssign_PageIndexChanged" 
                onpageindexchanging="db_VeiwAllAssign_PageIndexChanging" 
                onrowcommand="db_VeiwAllAssign_RowCommand" 
                onrowdatabound="db_VeiwAllAssign_RowDataBound" 
                onselectedindexchanged="db_VeiwAllAssign_SelectedIndexChanged" 
                onsorting="db_VeiwAllAssign_Sorting" PageSize="1" Width="1466px">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Begin Edite Date">
                        <ItemTemplate>
                            <%#Eval("beginEdite")%>
                        </ItemTemplate>
                    </asp:TemplateField>
