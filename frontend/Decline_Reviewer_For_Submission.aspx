<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Decline_Reviewer_For_Submission.aspx.cs" Inherits="Decline_Reviewer_For_Submission" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                Decline Reviewer For Submission<asp:Label ID="User_Name" runat="server" 
                    Text="------------"></asp:Label>
                &nbsp;&nbsp; </legend>
            <br />
            &nbsp;&nbsp;
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                CellPadding="3" DataKeyNames="User_No" GridLines="Vertical" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action ">
                        <ItemTemplate>
                            <asp:TextBox ID="User_No" runat="server" Enabled="False" 
                                Text=' <%#Eval("User_No")%>' Visible="False"></asp:TextBox>
                            ...
                            <br />
                            <asp:LinkButton ID="View_Reason_Decline" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="View_Reason_Decline" 
                                PostBackUrl="" Text="View Decline Reason " />
                            <br />
                        </ItemTemplate>
                    </asp:TemplateField>
