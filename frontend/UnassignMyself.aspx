<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UnassignMyself.aspx.cs" Inherits="UnassignMyself" Title="Untitled Page" %>
            ...
            <tr>
                <td class="style1" style="border-right-style: dotted; border-right-width: 1px" 
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" 
                        Font-Names="MS Reference Sans Serif" Font-Size="Large" Text="Unassign MySelf"></asp:Label>
                </td>
                <td class="style2" valign="top">
                    ...
                    <fieldset style="border-width: 1px 0px 1px 0px; width: 669px; height: 187px; background-color: #F2F2F2; border-top-style: solid; border-bottom-style: solid; font-family: 'MS Reference Sans Serif'; font-size: small;">
                        <br />
                        &nbsp;Are you sure you want to unassign Yuor Self? If you unassign the Editor from 
                        this submission,<br />
