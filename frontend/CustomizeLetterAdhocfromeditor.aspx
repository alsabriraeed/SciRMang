<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomizeLetterAdhocfromeditor.aspx.cs" Inherits="CustomizeLetterAdhocfromeditor" Title="Untitled Page" %>
    ...
    <div align="center" 
        ...
        <fieldset style="height: ; width: 812px; background-color: #F2F2F2;">
            ...
            <table align="center" cellpadding="0" cellspacing="0" class="" 
                style="border: 1px solid #FFFFFF;  height: 189px; font-size: small;">
                <tr valign="top">
                    <td align="left" class="">
                        &nbsp;From</td>
                ...
                <tr valign="top">
                    <td class="" colspan="2" valign="bottom">
                        <br />
                        &nbsp;&nbsp;<asp:TextBox ID="Txt_message_content" runat="server" Height="299px" 
