<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="New Assignments.aspx.cs" Inherits="New_Assignments" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                New Assignment -&nbsp;For&nbsp; (<asp:Label ID="User_Name" runat="server" Text="Label"></asp:Label>
                ) Editor&nbsp; </legend>
            <br />
            &nbsp;&nbsp;
            ...
            <asp:GridView ID="db_pending" runat="server" AllowPaging="True" 
                ...
                onrowcommand="db_pending_RowCommand" onrowdatabound="db_pending_RowDataBound" 
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="History" runat="server" 
                                ...
                                Text="History" />
                            <br />
                            <asp:LinkButton ID="Edit_Submission" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Edit_Submission" 
                                PostBackUrl="" Text="Edit Submission" />
                            <br />
                            ...
                            <br />
                            <asp:LinkButton ID="Assign_Editor" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Assign_Editor" 
                                PostBackUrl="" Text="Assign Editor" />
                            <br />
                            <asp:LinkButton ID="Invitat_Editor" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Invitat_Editor" 
                                PostBackUrl="" Text="Invitat Editor" />
                            <br />
                            ...
                            <br />
                            <asp:LinkButton ID="Unassign_Myself" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Unassign_Myself" 
                                PostBackUrl="" Text="Unassign Myself" />
                            <br />
                        </ItemTemplate>
