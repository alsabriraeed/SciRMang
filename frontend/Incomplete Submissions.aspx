<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Incomplete Submissions.aspx.cs" Inherits="Incomplete_Submissions" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            ...
            <br />
            <br />
            <asp:GridView ID="db_incomplete" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_incomplete_PageIndexChanged" 
                onpageindexchanging="db_incomplete_PageIndexChanging" 
                onrowcommand="db_incomplete_RowCommand" 
                onrowdatabound="db_incomplete_RowDataBound" 
                onselectedindexchanged="db_incomplete_SelectedIndexChanged" 
                onsorting="db_incomplete_Sorting" PageSize="1" Width="1466px">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <br />
                            <asp:LinkButton ID="Build_PDF" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Build_PDF" 
                                PostBackUrl="" Text="Build PDF" />
                            <br />
