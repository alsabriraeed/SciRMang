<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Submission Needing Approval by  Eidtor.aspx.cs" Inherits="Submission_Needing_Approval_by__Eidtor" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                Submission Needing Approval Editor For
            ...
            <br />
            <br />
            <asp:GridView ID="db_NeedAproval" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_NeedAproval_PageIndexChanged" 
                onpageindexchanging="db_NeedAproval_PageIndexChanging" 
                onrowcommand="db_NeedAproval_RowCommand" 
                onrowdatabound="db_NeedAproval_RowDataBound" 
                onselectedindexchanged="db_NeedAproval_SelectedIndexChanged" 
                onsorting="db_NeedAproval_Sorting" PageSize="1" Width="1466px">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <br />
                            <asp:LinkButton ID="Send_Back_to_Author" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Send_Back_to_Author" 
                                PostBackUrl="" Text="Send Back to Author" />
                            <br />
                    ...
                    <asp:TemplateField HeaderText="Date Edit Submissin">
                        <ItemTemplate>
                            <%#Eval("Edit_date")%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Date Build PDF">
                        <ItemTemplate>
                            <%#Eval("date_pdf")%>
                        </ItemTemplate>
                    </asp:TemplateField>
