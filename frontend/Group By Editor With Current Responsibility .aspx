<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Group By Editor With Current Responsibility .aspx.cs" Inherits="Group_By_Editor_With_Current_Responsibility_" Title="Untitled Page" %>
    ...
    <div style="border: 1pt solid #000000;  font-family: 'MS Reference Sans Serif'; ">
        <fieldset style="border-style: solid; border-color: #CCCCCC; width: 980px; height: 321px; margin-left: 15px; font-size: small; color: #000066; background-color: #EAEAEA; border-top-width: 1pt;">
            <legend style="border: 1pt solid #C0C0C0; color: #000066; font-size: medium; background-color: #FFFFFF; font-weight: bold;">
                Group By Editor with Current Resonsibility For
            ...
            &nbsp;&nbsp;&nbsp;
            <br />
            <asp:GridView ID="db_GroupbyAssigned_Current" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" BackColor="White" 
                BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                onpageindexchanged="db_GroupbyAssigned_Current_PageIndexChanged" 
                onpageindexchanging="db_GroupbyAssigned_Current_PageIndexChanging" 
                onrowcommand="db_GroupbyAssigned_Current_RowCommand" 
                onrowdatabound="db_GroupbyAssigned_Current_RowDataBound" 
                onselectedindexchanged="db_GroupbyAssigned_Current_SelectedIndexChanged" 
                onsorting="db_GroupbyAssigned_Current_Sorting" PageSize="1" Width="1466px">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Editor Name">
                        <ItemTemplate>
                            <asp:LinkButton ID="Editor_Name" runat="server" 
                                CommandArgument=' <%#Eval("Article_No")%>' CommandName="Editor_Name" 
                                PostBackUrl="" Text="Current Editor" />
                            <br />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
