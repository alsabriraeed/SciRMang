<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DeclineInvitationConfirmation.aspx.cs" Inherits="DeclineInvitationConfirmation" Title="Untitled Page" %>
        ...
        <table align="center" bgcolor="White" border="4" cellpadding="4" 
            ...
            <tr>
                <td class="style3" dir="ltr" 
                    ...
                    <br />
                    <br class="style5" />
                    <span class="style6">DECLINE INVITATION<br />
                    CONFIRMATION</span>
                </td>
                <td class="style2" style="border-style: none" valign="top">
                    ...
                    &nbsp;<fieldset id="field1" runat="server" 
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label2" runat="server" BackColor="#F4F4F4" 
                            ...
                            Text="Thank you for  considering the ivitation to Edit manuscript " Width="69%"></asp:Label>
                        &nbsp;<asp:Label ID="DECLINE_DATE" runat="server" BackColor="#F4F4F4" 
                            style="font-weight: 700" Text="استرجاع  تاريخ الرفض "></asp:Label>
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Default.aspx" 
                            style="text-decoration: underline; color: #0000CC">Return to main menue</asp:HyperLink>
                        <br />
                    </fieldset>
                </td>
            </tr>
